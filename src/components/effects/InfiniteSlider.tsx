...
const slidesRow1: ReactElement[] = pills.map((pill, index) => (
  <Pill hasStar key={index}>
    {pill}
  </Pill>
));
const slidesRow2: ReactElement[] = pills
  .slice()
  .reverse()
  .map((pill, index) => (
    <Pill hasStar key={index}>
...
const slidesRow3: ReactElement[] = pills.map((pill, index) => (
  <Pill hasStar key={index}>
    {pill}
  </Pill>
));
