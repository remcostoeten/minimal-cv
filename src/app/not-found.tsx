...
const NotFound = () => {
  ...
  return (
    <AnimatedElement opacity={0} duration={0.4} className="min-h-full">
      <div className="flex items-center justify-between gap-5 max-md:flex-col max-md:items-stretch max-md:gap-0">
        ...
        <AnimatedElement
          ...
          delay={0.5}
          x={15}
          className="error-svg ml-5 flex w-[46%] flex-col items-stretch max-md:mx-auto max-md:ml-0 max-md:w-full sm:w-30"
        >
          <ErrorIcon />
        </AnimatedElement>
      </div>
