...
function neovimIcon() {
  return (
    <svg width="33" height="33" viewBox="0 0 602 734" version="1.1" xmlns="http://www.w3.org/2000/svg" >
        <defs>
        ...
        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="markCopy" transform="translate(2.000000, 3.000000)">
                <path d="M0,155.5704 L155,-1 L154.999997,727 L0,572.237919 L0,155.5704 Z" id="Left--Green" fill="url(#linearGradient-1)"></path>
                <path d="M443.060403,156.982405 L600,-1 L596.818792,727 L442,572.219941 L443.060403,156.982405 Z" id="Right--Blue" fill="url(#linearGradient-2)" transform="translate(521.000000, 363.500000) scale(-1, 1) translate(-521.000000, -363.500000) "></path>
                <path d="M154.986294,0 L558,615.189696 L445.224605,728 L42,114.172017 L154.986294,0 Z" id="Cross--Blue" fill="url(#linearGradient-3)"></path>
                <path d="M155,283.83232 L154.786754,308 L31,124.710606 L42.4619486,113 L155,283.83232 Z" id="Shadow" fillOpacity="0.13" fill="#000000"></path>
            </g>
        </g>
    </svg>
  );
...
function figmaIcon() {
  return (
    ...
    <path d="M171.333 512C218.437 512 256.667 473.771 256.667 426.667V341.333H171.333C124.229 341.333 86 379.563 86 426.667C86 473.771 124.229 512 171.333 512Z" fill="#0ACF83"/>
    <path d="M86 256C86 208.896 124.229 170.667 171.333 170.667H256.667V341.333H171.333C124.229 341.333 86 303.104 86 256Z" fill="#A259FF"/>
    <path d="M86 85.3333C86 38.2293 124.229 0 171.333 0H256.667V170.667H171.333C124.229 170.667 86 132.437 86 85.3333Z" fill="#F24E1E"/>
    <path d="M256.667 0H342C389.104 0 427.333 38.2293 427.333 85.3333C427.333 132.437 389.104 170.667 342 170.667H256.667V0Z" fill="#FF7262"/>
    <path d="M427.333 256C427.333 303.104 389.104 341.333 342 341.333C294.896 341.333 256.667 303.104 256.667 256C256.667 208.896 294.896 170.667 342 170.667C389.104 170.667 427.333 208.896 427.333 256Z" fill="#1ABCFE"/>
    </g>
    <defs>
